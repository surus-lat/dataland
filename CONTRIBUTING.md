...
For data contributions, the contributor docs in [`docs/`](./docs/) cover the
full workflow:

- [Your first contribution](./docs/tutorial-first-contribution.md) — newcomer walkthrough
- [How to add a record](./docs/howto-add-record.md) — manual edit and HuggingFace skill paths
- [Schema reference](./docs/reference-schema.md) — vocabularies, record fields, validator rules

The conventions below cover branch and commit naming for any PR.
